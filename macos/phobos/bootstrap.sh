...
homebrew_casks=(
	alt-tab araxis-merge basictex brave-browser bruno chatgpt $compass docker
	fork iina kitty mac-mouse-fix ${microsoft[*]} numi obs rectangle signal
	tableplus transmission visual-studio-code whatsapp zoom
)
